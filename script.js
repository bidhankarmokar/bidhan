...
gsap.config({ force3D: !0, nullTargetWarn: !1 });
...
reveal(".home__content > *", "#home", { xPercent: -20 });
gsap.from(".home__img img", {
  scrollTrigger: { trigger: "#home" },
  scale: 0.8,
  opacity: 0,
  duration: 1.2,
  ease: "power3.out",
});
reveal(".stats__item", ".stats", { y: 60 });
reveal(".about__content > *", "#about", { xPercent: 20 });
...
reveal(".service__card", "#service", { y: 80, scale: 0.95 });
gsap.from(".work__card", {
  scrollTrigger: { trigger: "#work" },
  opacity: 0,
  scale: 0.85,
  y: 60,
  stagger: 0.2,
...
reveal(".testimonial__card", "#testimonials", { xPercent: 20 });
reveal(".blog__card", "#blog", { y: 80 });
reveal(".my__info > *", "#contact", { xPercent: -20 });
reveal(".form__container", "#contact", { xPercent: 20 });
reveal(".main__footer > *", ".main__footer", { y: 30 });
